    ...
    if (isPWA) {
        ...
        return (
            <div className="drawer w-fit h-full z-20">
                ...
                />
                <div className="drawer-content absolute top-0 left-0 z-10 md:pl-5">
                    <label
                        htmlFor="my-drawer"
                        className="btn btn-primary drawer-button p-3 md:p-5 rounded-2xl"
                    >
                        {checked ? <PanelLeftClose /> : <PanelLeftOpen />}
                    </label>
                </div>
                <div className="drawer-side pt-17">
                    <label
                        htmlFor="my-drawer"
                            ...
                            <details>
                                ...
                                <ul className="space-y-2">
                                    ...
                                    <li className="relative">
                                        ...
                                        <p className="absolute right-1 top-1.5 bg-info text-xs">
                                            bientôt
                                        </p>
                                    </li>
                                    <li>
