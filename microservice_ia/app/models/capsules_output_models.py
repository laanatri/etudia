...
class Flashcard(BaseModel):
    question: Annotated[str, Field(ge=1, le=150)]
    answer: Annotated[str, Field(ge=1, le=500)]

class QuizQuestion(BaseModel):
    question: Annotated[str, Field(ge=1, le=120)]
...
class CapsulesOutput(BaseModel):
    title: Annotated[str, Field(ge=1, le=100)]
    themes: str
